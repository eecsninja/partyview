                    ...
                    ParseUser.logInInBackground(username, password, new LogInCallback() {
                        ...
                        public void done(ParseUser user, ParseException e) {
                            ...
                            if (user != null) {
                                ...
                                if (e != null) {
                                    debugLog(getString(
                                            R.string.com_parse_ui_login_warning_parse_login_failed)
                                            +
                                            e.toString());
                                    if (e.getCode() == ParseException.OBJECT_NOT_FOUND) {
                                        if (config.getParseLoginInvalidCredentialsToastText()
                                                != null) {
                                            showToast(
                                                    config.getParseLoginInvalidCredentialsToastText());
                                        } else {
                                            showToast(
                                        ...
                                        showToast(
                                                R.string.com_parse_ui_parse_login_failed_unknown_toast);
                                    }
                                }
                            }
                        }
